...
%	\thispagestyle{empty}
\noindent\textbf{\underline{Instructor}}
\begin{multicols}{2}
$for(instructor)$
  \noindent\textbf{$instructor.name$}\\
  E: $instructor.email$\\
  T: $instructor.telephone$\\
  W: $if(instructor.web)$\href{http://$instructor.web$}{\tt $instructor.web$}$else$\href{https://www.newhaven.edu/faculty-staff-profiles}{\tt www.newhaven.edu}$endif$\\
...
\begin{multicols}{2}
\noindent\textbf{\underline{Class information}}\vspace{10pt}\\
  Course: $coursename$\\
...
\columnbreak
\noindent\textbf{\underline{Department Chair Contact Information}}\vspace{10pt}\\
\noindent\textbf{$chair_name$}\\
  Office: $chair_office$\\
  E: $chair_email$\\
  T: $chair_telephone$\\
\end{multicols}
